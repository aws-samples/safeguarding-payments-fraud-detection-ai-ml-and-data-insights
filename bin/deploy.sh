...
case ${SPF_DIR} in iac*)
  ...
  # terraform -v > /dev/null 2>&1 || { wget -q https://releases.hashicorp.com/terraform/1.12.2/terraform_1.12.2_linux_arm64.zip; unzip terraform_*.zip; mv terraform ${WORKDIR}/bin/terraform; }
  ...
  terraform -v > /dev/null 2>&1 || { wget -q https://releases.hashicorp.com/terraform/1.12.2/terraform_1.12.2_linux_386.zip; unzip terraform_*.zip; mv terraform ${WORKDIR}/bin/terraform; }
