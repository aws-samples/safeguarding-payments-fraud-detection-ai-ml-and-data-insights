...
phases:
  build:
    commands:
      ...
      - if [ -n "$SPF_GITHUB_TOKEN" ]; then git clone https://$SPF_GITHUB_TOKEN@github.com/aws-samples/safeguarding-payments-fraud-detection-ai-ml-and-data-insights; else git clone https://github.com/aws-samples/safeguarding-payments-fraud-detection-ai-ml-and-data-insights; fi
